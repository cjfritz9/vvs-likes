  ...
  const handleScrollIntoView = useCallback(
    (componentId: string) => {
      ...
      if (location === '/en/buy-instagram-likes-free-trial') {
        ...
        router.push(
          `/en/buy-instagram-likes-free-trial?scrollTo=${componentId}`
        );
      }
    },
    [location, router]
                ...
                <div className='col-md-6 d-flex align-items-center'>
                  <div className='banner-left'>
                    ...
                    <p className='text-start text-white banner_dis'>
                      Buy real Instagram likes & boost your posts to trigger
                      that satisfying buzz. Give our free trial a run & never
                      settle for fake engagement again.
                    </p>
